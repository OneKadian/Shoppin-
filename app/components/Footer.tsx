...
<div className="flex justify-center lg:justify-start space-x-6 mb-2 sm:mb-0">
  <a href="#" className="nav-link">Advertising</a>
  <a href="#" className="nav-link">Business</a>
  <a href="#" className="nav-link">How Search works</a>
</div>
<div className="flex justify-center lg:justify-start space-x-6 mt-4 lg:mt-0 text-white">
